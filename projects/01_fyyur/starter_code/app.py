...
class Artist(db.Model):
    ...
    def __repr__(self):
      return f'<Venue {self.id}, {self.name}, {self.city}, {self.state}, {self.phone}, {self.image_link}, {self.facebook_link}, {self.website}, {self.genres}, {self.seeking_venue}, {self.seeking_description}>'
...
def venues():
  ...
  for area in areas:
    ...
    areas = Venue.query.filter_by(area.state).filter_by(area.city).all()
...
def delete_venue(venue_id):
  ...
  try:
    ...
    flash('The venue and shows has been removed.')
    return render_template('pages/home.html')
